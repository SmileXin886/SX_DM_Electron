...
// 即梦AI Tab 的资源路径配置
const JIMENG_TAB_CONFIG = {
    containerId: 'page-jimeng',
    htmlUrl: 'jimeng/template.html',
    cssUrls: [
        'jimeng/css/layout.css',
        'jimeng/css/components.css',
        'jimeng/pages/assets/assets.css'
    ],
    jsUrls: [
        'jimeng/js/jimeng_state.js',
        'jimeng/js/jimeng_api.js',
        'jimeng/js/jimeng_dnd.js',
        'jimeng/pages/assets/assets.js',
        'jimeng/js/tab_jimeng.js'
    ],
    onLoaded: () => {
        if (window.JimengApp) window.JimengApp.init();
...
function initNavigation() {
    document.querySelectorAll('.nav-tab').forEach(tab => {
        tab.addEventListener('click', () => {
            ...
            // 【重构】使用 TabManager 按需加载即梦AI
            if (page === 'jimeng') {
                TabManager.load(
                    JIMENG_TAB_CONFIG.containerId,
                    JIMENG_TAB_CONFIG.htmlUrl,
                    JIMENG_TAB_CONFIG.cssUrls,
                    JIMENG_TAB_CONFIG.onLoaded,
                    JIMENG_TAB_CONFIG.jsUrls
                );
            }
        });
    });
